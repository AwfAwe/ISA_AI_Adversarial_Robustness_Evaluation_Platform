...
var Heading = /** @class */ (function () {
    ...
    Heading.prototype.generateList = function () {
        ...
        var listItem = (React__namespace.createElement("li", null,
            React__namespace.createElement("a", { href: "#".concat(replaceAll(link, this.customMatchers)) }, createTitle(this.title, this.titleLimit))));
        return React__namespace.createElement(React__namespace.Fragment, null, nestUl(this.level, listItem));
    };
    return Heading;
}());
/*
...
var nestUl = function (level, listItem) {
    switch (level) {
        case 1:
            return listItem;
        case 2:
            return React__namespace.createElement("ul", null, listItem);
        case 3:
            return (React__namespace.createElement("ul", null,
                React__namespace.createElement("ul", null, listItem)));
        case 4:
            return (React__namespace.createElement("ul", null,
...
var Toc = function (_a) {
    ...
    if (!headingTags)
        return null;
    return (React__namespace.createElement("ul", { className: style }, headingTags.map(function (heading, index) { return (React__namespace.createElement(React__namespace.Fragment, { key: index }, heading)); })));
};
